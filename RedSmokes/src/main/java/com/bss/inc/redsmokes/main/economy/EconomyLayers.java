...
public final class EconomyLayers {
    ...
    public static void onEnable(final RedSmokes redSmokes) {
        redSmokes.scheduleSyncDelayedTask(() -> {
            ...
            for (final Plugin plugin : Bukkit.getPluginManager().getPlugins()) {
                ...
                if (layer != null) {
                    redSmokes.getLogger().log(Level.INFO, "Essentials found a compatible payment resolution method: " + layer.getName() + " (v" + layer.getPluginVersion() + ")!");
                }
            }
