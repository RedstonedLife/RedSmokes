...
import import com.bss.inc.redsmokes.main.utils.
...
public class MetaItemStack {
    ...
    public void addStringMeta(final CommandSource sender, final boolean allowUnsafe, final String string, final IRedSmokes ess) throws Exception {
    ...
    private void setUnbreakable(final IRedSmokes redSmokes, final ItemStack is, final boolean unbreakable) {
        final ItemMeta meta = is.getItemMeta();
        redSmokes.getItemUnbreakableProvider().setUnbreakable(meta, unbreakable);
        is.setItemMeta(meta);
    }
}
