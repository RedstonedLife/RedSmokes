...
import net.redsmokes.api.InvalidWorldException;
...
import com.bss.inc.redsmokes.main.config.serializers.*;
...
public class RedSmokesConfiguration {
    ...
    public RedSmokesConfiguration(final File configFile, final String templateName, final String header) {
        ...
        RedSmokes.getWrappedLogger().log(Level.INFO, "Template Name for config is " + templateName + " | Header: " + header + " | configFile: " + configFile.toString());
    }
     ...
     * <p>
     * A transaction informs RedSmokes to pause the saving of data. This is should be used when
