...
public class Economy {
    ...
    private static IRedSmokes redSmokes;
    ...
    /**
     * @param aRedSmokes the redSmokes to set
     */
    public static void setEss(final IRedSmokes aRedSmokes) {
        redSmokes = aRedSmokes;
    }
    ...
    public static void divide(final String name, final double amount) throws UserDoesNotExistException, NoLoanPermittedException, MaxMoneyException {
        try {
            ...
            redSmokes.getLogger().log(Level.WARNING, "Failed to divide balance of " + name + " by " + amount + ": " + e.getMessage(), e);
        }
    }
